...
#ifdef CONFIG_VIDEO_OV7640
#include <media/ov7640_platform.h>
#endif

#ifdef CONFIG_SOC_CAMERA_OV7725
#include <media/ov7725_platform.h>
#endif
...
#ifdef CONFIG_VIDEO_OV7640
static int ov7640_power_en(int onoff)
{
#define OV7640_PWR_EN		S5PV210_GPJ2(4)

	gpio_request(OV7640_PWR_EN, "GPJ2_4");
	gpio_direction_output(OV7640_PWR_EN, onoff);
	gpio_free(OV7640_PWR_EN);

	printk("ov7640: power %s\n", onoff ? "ON" : "Off");
	return 0;
}

static struct ov7640_platform_data ov7640_plat = {
	.default_width = 640,
	.default_height = 480,
	.pixelformat = V4L2_PIX_FMT_YUYV,
	.freq = 40000000,
...
static struct i2c_board_info ov7640_i2c_info = {
	I2C_BOARD_INFO("ov7640", (0x42>>1)),
	.platform_data = &ov7640_plat,
};

static struct s3c_platform_camera ov7640 = {
	.id			= CAMERA_PAR_A,
	.type		= CAM_TYPE_ITU,
	.fmt			= ITU_601_YCBCR422_8BIT,
	.order422	= CAM_ORDER422_8BIT_YCBYCR,
	.i2c_busnum	= 0,
	.info		= &ov7640_i2c_info,
	.pixelformat= V4L2_PIX_FMT_YUYV,
	.srclk_name	= "mout_mpll",
	/* .srclk_name	= "xusbxti", */
	.clk_name	= "sclk_cam1",
	...
	.initialized	= 0,
	.cam_power	= ov7640_power_en,
};
#endif

#ifdef CONFIG_SOC_CAMERA_OV7725
static int ov7725_power_en(int onoff)
{
#define OV7725_PWR_EN		S5PV210_GPJ2(4)

    gpio_request(OV7725_PWR_EN, "GPJ2_4");
    gpio_direction_output(OV7725_PWR_EN, onoff);
    gpio_free(OV7725_PWR_EN);

    printk("ov7725: power %s\n", onoff ? "ON" : "Off");
    return 0;
}

static struct ov7725_platform_data ov7725_plat = {
    .default_width = 640,
    .default_height = 480,
    .pixelformat = V4L2_PIX_FMT_YUYV,
    .freq = 40000000,
...
static struct i2c_board_info ov7725_i2c_info = {
    I2C_BOARD_INFO("ov7725", (0x42>>1)),
    .platform_data = &ov7725_plat,
};

static struct s3c_platform_camera ov7725a = {
    .id			= CAMERA_PAR_A,
    .type		= CAM_TYPE_ITU,
	.fmt			= ITU_601_YCBCR422_8BIT,
	.order422	= CAM_ORDER422_8BIT_YCBYCR,
    .i2c_busnum	= 0,
    .info		= &ov7725_i2c_info,
    .pixelformat= V4L2_PIX_FMT_YUYV,
    .srclk_name	= "mout_mpll",
    /* .srclk_name	= "xusbxti", */
    .clk_name		= "sclk_cam1",
    ...
    .initialized	= 0,
    .cam_power	= ov7725_power_en,
};

static struct s3c_platform_camera ov7725b = {
    .id			= CAMERA_PAR_B,
    .type		= CAM_TYPE_ITU,
	.fmt			= ITU_601_YCBCR422_8BIT,
	.order422	= CAM_ORDER422_8BIT_YCBYCR,
...
#define TSC2007_INT_GPIO S5PV210_GPH1(2)
...
static struct i2c_board_info i2c_devs2[] __initdata = {
...
#ifdef CONFIG_TOUCHSCREEN_TSC2007
    {
        ...
        .irq=IRQ_EINT(10),						//S5PV210_GPH1(2)为外部中断18
